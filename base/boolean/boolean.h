...
/**
 * @file      boolean.h
 * @brief     Common Boolean-related types and operations
 *
 ...
 *            `cpplint.py --linelength=120 boolean.h`
 *
 * @date      February 2015
 *
 ...
 */
/* ************************************************************************** */
#ifndef UNITEX_BASE_BOOLEAN_BOOLEAN_H_                              // NOLINT
#define UNITEX_BASE_BOOLEAN_BOOLEAN_H_                              // NOLINT
/* ************************************************************************** */
#include "base/boolean/safe_bool.h"
/* ************************************************************************** */
#endif  // UNITEX_BASE_BOOLEAN_BOOLEAN_H_                           // NOLINT
