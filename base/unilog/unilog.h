...
/**
 * @file      unilog.h
 * @brief     Unicode-aware and thread-safe message logging library
 *
 ...
 *            `cpplint.py --linelength=120 unilog.h`
 *
 * @date      February 2015
 *
 ...
 */
/* ************************************************************************** */
#ifndef UNITEX_BASE_UNILOG_UNILOG_H_                                // NOLINT
#define UNITEX_BASE_UNILOG_UNILOG_H_                                // NOLINT
/* ************************************************************************** */
#include "base/unilog/severity_level.h"
/* ************************************************************************** */
#endif  // UNITEX_BASE_UNILOG_UNILOG_H_                             // NOLINT
