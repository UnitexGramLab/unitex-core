...
/**
 * @file      time.h
 * @brief     Portable time-related functions and types
 *
 * @author    cristian.martinez@univ-paris-est.fr (martinec)
 *
 * @attention Do not include this file directly, rather include the
 *            base/time/time.h header file to gain this file's
 *            functionality
 *
 ...
 */
/* ************************************************************************** */
#ifndef UNITEX_BASE_TIME_TIME_H_                                    // NOLINT
#define UNITEX_BASE_TIME_TIME_H_                                    // NOLINT
/* ************************************************************************** */
#include "base/time/types.h"
#include "base/time/functions.h"
#include "base/time/chrono.h"
/* ************************************************************************** */
#endif  // UNITEX_BASE_TIME_TIME_H_                                 // NOLINT
