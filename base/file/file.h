...
/**
 * @file      file.h
 * @brief     Common file-related functions
 *
 * @author    cristian.martinez@univ-paris-est.fr (martinec)
 *
 *
 * @attention Do not include this file directly, rather include the
 *            base/file/file.h header file to gain this file's
 *            functionality
 *
 ...
 */
/* ************************************************************************** */
#ifndef UNITEX_BASE_FILE_FILE_H_                                    // NOLINT
#define UNITEX_BASE_FILE_FILE_H_                                    // NOLINT
/* ************************************************************************** */
#include "base/file/path_separator.h"
/* ************************************************************************** */
#endif  // UNITEX_BASE_FILE_FILE_H_                                 // NOLINT
