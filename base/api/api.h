...
/**
 * @file      api.h
 * @brief     Common API-related macros
 *
 ...
 */
/* ************************************************************************** */
#ifndef UNITEX_BASE_API_API_H_                                      // NOLINT
#define UNITEX_BASE_API_API_H_                                      // NOLINT
/* ************************************************************************** */
#include "base/api/call.h"
#include "base/api/callback.h"
#include "base/api/dll.h"
#include "base/api/unmangle.h"
/* ************************************************************************** */
#endif  // UNITEX_BASE_API_API_H_                                   // NOLINT
