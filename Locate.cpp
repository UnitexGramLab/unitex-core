...
const char* usage_Locate =
         ...
         "\n"
         "Maximum iteration per token options:\n"
         "  -o N/--stop_token_count=N : stop after N iteration on a token\n"
         "  -o N,M/--stop_token_count=N,M : emit warning after N iteration on a token\n"
