...
inline void list_aut_delete(list_aut * l) { vector_delete(l, (release_f) autalmot_delete); }

inline int list_aut_add(list_aut * l, autalmot_t * A) { return vector_add(l, (void *) A); }
