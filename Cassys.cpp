 ...
 * Unitex
 *
 * Copyright (C) 2001-2013 Universit√© Paris-Est Marne-la-Vall√©e <unitex@univ-mlv.fr>
 *
...
//					cassys_tokens_2_graph(tokens_list,graph_file_name_n);
	...
	// construct_xml_concord doit Ítre appelÈ si on veut voir la concordance au format XML
