...
cassys_tokens_list *add_replaced_text(const char *text, cassys_tokens_list *list, int previous_transducer, int previous_iteration,
		 int transducer_id, int iteration, const char *alphabet, const VersatileEncodingConfig*);
...
cassys_tokens_list *new_list(list_ustring *u, int transducer_id, int iteration);
