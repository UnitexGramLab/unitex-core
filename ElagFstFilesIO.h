...
Elag_Tfst_file_in* load_tfst_file(const VersatileEncodingConfig*,char*,language_t*);
void load_tfst_sentence_automaton(Elag_Tfst_file_in*,int);
void tfst_file_close_in(Elag_Tfst_file_in*);

Elag_fst_file_in* load_fst_file(const VersatileEncodingConfig*,char*,int,language_t*);
