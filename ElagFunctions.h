...
void remove_ambiguities(char* input_tfst,vector_ptr* grammars,char* output_tfst,language_t* language);
void explode_tfst(char* input_tfst,char* output_tfst,language_t* language);
