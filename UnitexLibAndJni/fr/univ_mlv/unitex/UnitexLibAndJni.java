...
/**
 * UnitexLibAndJni is the import java class for Unitex JNI libary
 * @author Gilles Vollant (Ergonotics SAS)
 * <br>
 * created and contributed by Gilles Vollant (Ergonotics SAS) 
 * as part of an UNITEX optimization and reliability effort
 * <br>
...
public class UnitexLibAndJni  {

        // Load the dll that exports functions callable from java
    static {
        System.loadLibrary("UnitexLibAndJni");
        }
    ...
    /**
     * Function to run UnitexTool with string or string array, like java exec in java runtime
     * <br>
     ...
     */
         ...
         * @return true for version of Unitex which uses file offset (stating Unitex 3.0) 
         */
        ...
        /*
         * file function below are compatible with both disk file system and abstract file system 
         */
        ...
        /**
         * create a file from a string using UTF16LE encoding with BOM (native Unitex format)
         */
        ...
        /**
         * function to enable or disable logger (creating .ULP log file when
         * run an Unitex tool)
         * logger function must NOT be used when another thread uses a function from this JNI
         */
        
        /**
         * enable logger and write log file on loggerFolder
         * if storeFileOut is TRUE, log will contain destination file
         */
        public native static boolean installLogger(String loggerFolder, boolean storeFileOut);
         ...
         */
	      public static final String combineUnitexFileComponent(String ... FilePathNameItems)
  	      {
  			  String retStr="";
	      ...
	      /**
	       * combine several path items and a filename to create a full filename with quote 
	       */
  	      public static final String combineUnitexFileComponentWithQuote(String ... FilePathNameItems)
  	      {
  			  String retStr="";
  			  String pSep = pathSeparator;
  			  boolean isFirst=true;
